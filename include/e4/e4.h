...
/** Operation succeeded without error \ingroup group_e4 */
#define E4ERR_Ok                    0
/** Invalid authentication tag indicates corrupted ciphertext \ingroup group_e4 */
#define E4ERR_InvalidTag            -101
/** Message received outside of error window for clock. \ingroup group_e4 */
#define E4ERR_TimestampInFuture     -102
/** Message received outside of error window for clock. \ingroup group_e4 */
#define E4ERR_TooOldTimestamp       -103
/** Ciphertext too short. \ingroup group_e4 */
#define E4ERR_TooShortCiphertext    -104
/** Unable to find key for topic; could not decrypt.\ingroup group_e4 */
#define E4ERR_TopicKeyMissing       -105
/** Message has already been seen. \ingroup group_e4 */
#define E4ERR_ReplayedMessage       -106
/** E4 Protocol command invalid. Internal error. \ingroup group_e4 */
#define E4ERR_InvalidCommand        -107
/** E4 Persistence layer reported an error. \ingroup group_e4 */
