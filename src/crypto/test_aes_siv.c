...
int test_aes_siv()
{
    ...
    const uint8_t test_ivc[30] = {
        ...
        0xbb, 0xc9, 0x35, 0xb2, 0xd2, 0x8d, 0x10, 0xd1, 
    ...
    const uint8_t test_jp[80] = {
        ...
        160,  45, 237,  93, 164, 200,  69, 177, 144,  88, 
         25,  34, 203,   0, 222,   9,  31, 200, 251, 127, 
          6,  91, 145, 230, 145, 187,  85, 154, 214, 154, 
        130, 152,  98,  74, 163,  29, 244, 187, 138,  58, 
        140, 254,  85, 107, 236, 245, 212, 233, 150, 187, 
        147, 172,  20,  22, 177,  76,  75, 137,  57, 249, 
